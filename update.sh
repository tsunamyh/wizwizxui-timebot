...
do
	case $opt in
		"Update bot")
			...
			sleep 3
			git clone https://github.com/tsunamyh/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/tsunamyh/wizwizxui-timebot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
