...
```
bash <(curl -s https://raw.githubusercontent.com/tsunamyh/wizwizxui-timebot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/tsunamyh/wizwizxui-timebot/main/update.sh)
```
