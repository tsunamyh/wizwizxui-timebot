...
",
    ...
    'send_only_number'=> "😡 | فقط اعداد انگلیسی بفرست!",
    ...
    'start_message'=>'سلام به ربات خرید فیلترشکن خوش اومدی 😍
🗿 مناسب برای همه‌ی اپراتورها  

☎️ پشتیبانی آنلاین                                                 @tsunamyh
📢 کانال اطلاع رسانی                                               @iamvpnch

 /start',
    'new_member_joined'=>"📢 | یه نفر عضو ربات شد :

نام و نام خانوادگی: FULLNAME
نام کاربری: @USERNAME
آیدی عددی: USERID

اگه دوست داشتی یه پیام براش بفرست  😍",
    "not_joine_yet"=>"هنوز که عضو کانال نشدی",
    'insert_discount_code'=>"🎁|کد تخفیف  را وارد کن:",
...
از این بخش میتوانید خرید تکی و خرید انبوه داشته باشید و همچنین کانفیگ های خریداری شده را مدیریت کنید",
    ...
    'no_server_available'=>"😔 | عزیز دلم فعلا هیچ سرور فعالی نداریم لطفا بعدا تست کن",
